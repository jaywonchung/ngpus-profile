...
() {
  ...
  typeset -g POWERLEVEL9K_MODE=default

  typeset -ga POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
      host virtualenv dir_writable dir vcs status)

  typeset -ga POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
      command_execution_time background_jobs custom_rprompt)
  ...
  typeset -g POWERLEVEL9K_HOST_LOCAL_BACKGROUND=none
  typeset -g POWERLEVEL9K_HOST_REMOTE_BACKGROUND=none
  typeset -g POWERLEVEL9K_HOST_LOCAL_FOREGROUND=012
  typeset -g POWERLEVEL9K_HOST_REMOTE_FOREGROUND=012
  typeset -g POWERLEVEL9K_SSH_ICON=''
  typeset -g POWERLEVEL9K_HOST_TEMPLATE='%m:'

  typeset -g POWERLEVEL9K_VIRTUALENV_BACKGROUND=none
  typeset -g POWERLEVEL9K_VIRTUALENV_FOREGROUND=051
  typeset -g POWERLEVEL9K_PYTHON_ICON='(e)'
